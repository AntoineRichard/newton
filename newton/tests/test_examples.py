...
class TestWheeledExamples(unittest.TestCase):
    pass


add_example_test(
    TestWheeledExamples,
    name="wheeled.example_wheeled_drive",
    devices=test_devices,
    test_options={"usd_required": True, "num-frames": 360, "world-count": 2},
    use_viewer=True,
)

add_example_test(
    TestWheeledExamples,
    name="wheeled.example_wheeled_force_drive",
    devices=test_devices,
    test_options={"usd_required": True, "num-frames": 120, "world-count": 2},
    use_viewer=True,
)

add_example_test(
    TestWheeledExamples,
    name="wheeled.example_wheeled_tire_drive",
    devices=test_devices,
    test_options={"usd_required": True, "num-frames": 120, "world-count": 2},
    use_viewer=True,
)
...
add_example_test(
    TestWheeledExamples,
    name="wheeled.example_wheeled_car_control",
    devices=test_devices,
    test_options={
        "usd_required": True,
        "num-frames": 240,
...
add_example_test(
    TestWheeledExamples,
    name="wheeled.example_wheeled_terrain_contact",
    devices=test_devices,
    test_options={"usd_required": True, "num-frames": 180, "world-count": 2},
    use_viewer=True,
)
...
add_example_test(
    TestWheeledExamples,
    name="wheeled.example_wheeled_husky_control",
    devices=test_devices,
    test_options={"usd_required": True, "num-frames": 180, "world-count": 2},
    use_viewer=True,
)
