...
- Add `ModelBuilder.get_custom_frequency_count()` to query the number of rows currently allocated for a custom attribute frequency, e.g. for assigning contiguous per-row ids when stamping custom attributes
