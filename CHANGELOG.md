...
- Add hydroelastic contact support for analytic ground planes, so a plane marked `is_hydroelastic=True` forms a finite contact patch against SDF shapes without requiring a generated plane SDF.
